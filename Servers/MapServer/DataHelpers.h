...
void sendResult(Entity &src,Entity &tgt, String name, float value);
 ...
 * Lua Functions
 */
uint32_t addNpc(MapClientSession &sess, String &npc_name, glm::vec3 &loc, int variation, String &name);
uint32_t addNpcWithOrientation(MapClientSession &sess, const String &name, glm::vec3 &loc, int variation,
                                      glm::vec3 &ori, const String &npc_name);
uint32_t addNpcWithOrientation(MapInstance &mi, const String &name, glm::vec3 &loc, int variation, glm::vec3 &ori,
                               const String &npc_name);
void giveEnhancement(MapClientSession &sess, const String &name, int level);
...
uint32_t addVictim(MapInstance &mi, const String &name, glm::vec3 &loc, int variation, glm::vec3 &ori,
                   const String &npc_name);
