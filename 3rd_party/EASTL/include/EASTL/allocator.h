...
namespace eastl
{
    ...
    /// dummy_allocator
    ///
	/// Defines an allocator which does nothing. It returns nullptr from allocate calls.
    ///
...
namespace eastl
{
    ...
    {
		return nullptr; // By default we return nullptr; the user must make specialization of this function in order to provide their own implementation.
    }
