...
namespace eastl
{
    ...
    public:
      ...
      //iterator                               insert(const_iterator hint, node_type&& nh);
        ...
        template <typename U, typename UHash=hash<U>, typename BinaryPredicate=equal_to<> >
        bool contains_as(const U& u, UHash uhash=UHash(), BinaryPredicate predicate=BinaryPredicate()) const {
